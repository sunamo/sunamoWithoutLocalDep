...
internal class CAChangeContent
{
    ...
    internal static List<string> ChangeContent0(ChangeContentArgsWikipedia a, List<string> files_in, Func<string, string> func)
    {
    ...
    /// <param name="a1"></param>
    /// <returns></returns>
    internal static List<string> ChangeContent1(ChangeContentArgsWikipedia a, List<string> files_in, Func<string, string, string> func, string a1)
    {
    ...
    /// <param name="a2"></param>
    /// <returns></returns>
    internal static List<string> ChangeContent2(ChangeContentArgsWikipedia a, List<string> files_in, Func<string, string, string, string> func, string a1, string a2)
    {
        for (int i = 0; i < files_in.Count; i++)
        {
    ...
    /// <param name="files_in"></param>
    /// <param name="func"></param>
    internal static bool ChangeContentWithCondition(ChangeContentArgsWikipedia a, List<string> files_in, Predicate<string> predicate, Func<string, string> func)
    {
        bool changed = false;
        for (int i = 0; i < files_in.Count; i++)
        {
    ...
    internal static List<string> ChangeContent<Arg1, Arg2>(ChangeContentArgsWikipedia a, List<string> files_in, Func<string, Arg1, Arg2, string> func, Arg1 arg1, Arg2 arg2)
    {
        for (int i = 0; i < files_in.Count; i++)
        {
