...
using SunamoRoslyn2_LaterMergeToSunamoRoslyn.Collectors;
using System;
...
namespace SunamoRoslyn2_LaterMergeToSunamoRoslyn.Extensions;
public static class ListExtensions
{
    ...
    public static async Task<List<T>> RemoveAllAlsoFromFile<T>(this List<T> cl, Predicate<T> match, string path) where T : BaseTypeDeclarationSyntax
    {
        ...
        for (int i = 0; i < toRemove.Count; i++)
        {
            ...
            await File.WriteAllTextAsync(newFp, item.ToString());
        }
